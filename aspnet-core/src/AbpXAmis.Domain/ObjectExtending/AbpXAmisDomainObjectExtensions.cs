...
namespace AbpXAmis.ObjectExtending
{
    public static class AbpXAmisDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpXAmisEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
